...
<?php if ($comments) : ?>
	...
	<?php foreach ($comments as $comment) : ?>
        ...
        <li <?php echo $oddcomment; ?>id="comment-<?php comment_ID() ?>">
            <div class="fl_left">
            	<div class="avatarImg"><?php if(function_exists("get_avatar")) echo get_avatar( $comment, 35 ); ?></div>
            	<div class="commentAuthor">
                	<div class="authorName"><?php comment_author_link() ?></div>
					<span class="commentTime"><?php comment_date('j-M-y') ?> | <?php comment_time('g:i a');  ?> <?php edit_comment_link('Edit','| ',''); ?></span>
                </div>
