...
<?php if ( ! is_ajax() ) : ?><div id="order_review"><?php endif; ?>
	...
	<?php do_action( 'woocommerce_review_order_before_payment' ); ?>
		...
		<div style="display: block" class="<?php if ($checkoutType != 'quick'): ?>row-fluid<?php endif ?>">
			...
			<div class="<?php if ($checkoutType != 'quick'): ?>span4 fl-r<?php endif ?> cart_totals">

				<h4><?php _e('Cart totals', ETHEME_DOMAIN) ?></h4>
