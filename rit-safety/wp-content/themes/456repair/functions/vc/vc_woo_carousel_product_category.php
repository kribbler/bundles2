...
function vc_woo_carousel_product_category_func( $atts, $content = null ) { // New function parameter $content is added!
   ...
   'carousel_loop' => '',
		...
		if ( $products->have_posts() ) : ?>
			...
			<div class="row">
			<ul class="lpd-products owl-carousel-<?php echo $carousel_product_category_ID;?>">
...
add_shortcode( 'vc_woo_carousel_product_category', 'vc_woo_carousel_product_category_func' );

class carousel_product_category_class
{
    protected static $var = '';

    public static function carousel_product_category_callback(){
	...
	$columns = $shortcode_atts['columns'];
		...
		/* <![CDATA[ */
            jQuery(document).ready(function() {
              jQuery('.owl-carousel-<?php echo $carousel_product_category_ID;?>').owlCarousel({
...
vc_map(array(
   "name" => __("Product Category Carousel", GETTEXT_DOMAIN),
   "base" => "vc_woo_carousel_product_category",
   "class" => "",
   "icon" => "icon-wpb-lpd",
