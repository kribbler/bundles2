			...
			<?php }?>
		        ...
		        <div class="lpd-cbp-wrapper">
		            ...
		            <div class="cbp-l-loadMore-button">
		                <a href="<?php echo get_template_directory_uri(). '/assets/cbp-plugin/ajax/more-portfolio.php?id='. $the_cube_t_ID .'&items='. $items.'&metadata='. $metadata.'&thumbnail='. $thumbnail.'&caption_type='. $caption_type.'&taxo_slug='.$taxo_slug.'&taxo_type=portfolio_category&caption_align='. $caption_align; ?>" class="cbp-l-loadMore-button-link btn-default btn"><?php _e('LOAD MORE', GETTEXT_DOMAIN) ?></a>
		            </div>
		            <?php }?>
