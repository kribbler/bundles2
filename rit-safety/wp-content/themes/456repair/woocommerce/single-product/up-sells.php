...
?>
			...
			<div class="lpd-upsells lpd-products">
				...
				<h2 class="lpd-heading-title<?php if($product_bottom_a_type){?> cre-animate<?php }?>"<?php if($product_bottom_a_type){ echo $animation_att;}?>><span><?php _e( 'You may also like&hellip;', 'woocommerce' ) ?></span></h2>
