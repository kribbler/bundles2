...
$animation_att = ' data-animation="'.$product_image_a_type.'" data-speed="'.$product_image_a_speed.'" data-delay="'.$product_image_a_delay.'" data-offset="'.$product_image_a_offset.'" data-easing="'.$product_image_a_easing.'"';
