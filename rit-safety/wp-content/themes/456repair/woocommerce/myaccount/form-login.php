...
<?php endif; ?>
		...
		<form method="post" class="login my-account-lg-rg">
			...
			<p class="form-row">
				...
				<input type="submit" class="btn-primary btn" name="login" value="<?php _e( 'Login', 'woocommerce' ); ?>" /> 
...
<?php if ( get_option( 'woocommerce_enable_myaccount_registration' ) === 'yes' ) : ?>
	...
	<div class="col-md-6">
		...
		<form method="post" class="register my-account-lg-rg">
			...
			<p class="form-row">
				...
				<input type="submit" class="btn-primary btn" name="register" value="<?php _e( 'Register', 'woocommerce' ); ?>" />
			</p>
