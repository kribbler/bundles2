        ...
        <div id="afl-edit-item-tabs-content<?php print '999'?>">
            <table class="form-table" cellpadding="0">
                <tbody>
                    ...
                    <tr valign="top">
                        <th><?php print __('How many items? : ', $domain); ?></th>
                        <td>
                            <?php print afl_render_theme_option("afl-content-count", array('type' => 'text', 'default_value'=> (intval($data['content_count'])>0?intval($data['content_count']):get_option('posts_per_page')), 'attributes' => array('name' => "content_count"))); ?>
                        </td>
                    </tr>
                </tbody>
            </table>
