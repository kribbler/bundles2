...
class MY_TwitterWidget extends WP_Widget {
    ...
    public function __construct() {
        parent::__construct(
            ...
            'Twitter', // Name
            array( 'description' => __( 'Display latest Tweets from Twitter. With query search: from:<your twitter name>, <@ or #><search string>', 'dx' ), ) // Args
        );
    }
    ...
    function form( $instance ) {
        ...
        ?>
        <p>
            <label for="<?php echo $this->get_field_id('title') ?>"><?php _e('Title','dx'); ?></label>
            <br>
        ...
        <p><label for="<?php echo $this->get_field_id('consumer_key'); ?>"><?php _e('Consumer Key','dx') ?></label><br />
        ...
        <p>
            <label for="<?php echo $this->get_field_id('consumer_secret') ?>"><?php _e('Consumer Secret', 'dx') ?></label><br />
        ...
        <p><label for="<?php echo $this->get_field_id('query') ?>"><?php _e('Search Query (<a href="https://dev.twitter.com/docs/using-search" target="_blank" title="Read more about Twitter Search query">?</a>)','dx') ?></label><br />
        ...
        <p><label for="<?php echo $this->get_field_id('number') ?>"><?php _e('Number of Tweets','dx') ?></label>&nbsp;<input type="text" name="<?php echo $this->get_field_name
        ...
        <p><label for="<?php echo $this->get_field_id('show_follow') ?>">
                ...
                <?php _e('Show Follow Button?', 'dx') ?></label>
        </p>
        <p><label for="<?php echo $this->get_field_id('show_account') ?>">
                ...
                <?php _e('Show Account Info?', 'dx') ?></label>
        </p>
        <p><label for="<?php echo $this->get_field_id('show_avatar') ?>">
                ...
                <?php _e('Show User Avatar?', 'dx') ?></label>
        </p>
