<?php
/*
 * Template Name: Video and Gallery
 */
		...
		<div class="col-lg-12 bottom-border">
			...
			<div class="container">
				...
				<div class="col-lg-8 center_me">
					...
					<?php echo apply_filters('the_content', rwmb_meta( 'dd_video_description' )); ?>
				</div>
				<div class="col-lg-2">&nbsp;</div>
			</div>
		</div>
			...
			<div class="col-lg-8">
				<?php if (have_posts()): ?>
					<?php while(have_posts()) : the_post(); ?>
						...
						<div class="center_me">
							<p>
								<a href="#">Departure and Return</a> | <a href="#">View Rates</a>
							</p>
							<p>
								<a class="btn" href="#">Request a Reservation</a>
							</p>
						</div>
						<?php } ?>
					<?php endwhile; ?>
