...
<div class="white-wrap container-fluid">
	<div class="row">
		<div class="col-lg-12 bottom-border">
			...
			<h3 class="center_me"><?php echo rwmb_meta('dd_dining_video_title'); ?></h3>
			<div class="center_me">
				<?php echo apply_filters('the_content', rwmb_meta( 'dd_dining_video_url' )); ?>
			</div>
		</div>
	</div>
</div>
...
<div class="white-wrap container margin_bottom_40">
	...
	<div class="gallery row">
		<?php echo do_shortcode( rwmb_meta( 'dd_dining_gallery_images' ) ); ?>
