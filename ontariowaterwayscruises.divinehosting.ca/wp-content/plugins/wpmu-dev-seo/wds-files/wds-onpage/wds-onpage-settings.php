...
function wds_seoopt_settings() {
	...
	<p>This plugin also adds a SmartCrawl module below the Write Post / Page editor which you can use to customise SEO options for individual posts and pages.</p>' , 'wds' ), WDS_PLUGIN_URL . 'images/onpagesample.png' );
	...
	if ( WDS_SITEWIDE || 'posts' == get_option('show_on_front') ) {
		...
		$intro = '<p>' . __('You seem to be using a static front page. You can tweak its SEO settings using the SmartCrawl metabox in your Page editor.', 'wds') . '</p>';
