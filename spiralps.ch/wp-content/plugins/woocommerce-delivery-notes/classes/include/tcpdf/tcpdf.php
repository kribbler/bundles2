...
class TCPDF {
	 ...
	 * @public
	 */
	public function setFooterData($tc=array(0,0,0), $lc=array(0,0,0), $footer_text) {
		$this->footer_text_color = $tc;
		$this->footer_line_color = $lc;
		$this->footer_text_aurelie = $footer_text;
	}
	...
	public function Footer() {
		...
		$pagenumtxt = $this->footer_text_aurelie;
		$this->SetY($cur_y);
		//Print page number
		if ($this->getRTL()) {
			$this->SetX($this->original_rMargin);
