...
library_load_class_by_name('Customweb_Payment_Authorization_IOrderContext');
 ...
 *
 */
abstract class PostFinanceCw_AbstractCartOrderContext implements Customweb_Payment_Authorization_IOrderContext
{
	protected $cart;
	...
	public function getBillingState() {
		return $this->userData['billing_state'];
	}
	...
	public function getShippingState() {
		if ($this->isShipToBilling()) {
			...
			return $this->userData['shipping_state'];
		}
