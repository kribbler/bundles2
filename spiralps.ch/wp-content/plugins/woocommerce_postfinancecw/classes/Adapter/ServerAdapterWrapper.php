...
library_load_class_by_name('Customweb_Payment_Authorization_Server_AbstractWrapper');
library_load_class_by_name('Customweb_Form_Renderer');
require_once 'IAdapter.php';

class PostFinanceCw_Adapter_ServerAdapterWrapper extends Customweb_Payment_Authorization_Server_AbstractWrapper implements PostFinanceCw_Adapter_IAdapter
{
	...
	public function getCheckoutFormVaiables(PostFinanceCw_Transaction $dbTransaction, $failedTransaction) {
		...
		$formActionUrl = PostFinanceCwUtil::getPluginUrl("notification.php", array('cw_transaction_id' => $dbTransaction->getTransactionId()));
