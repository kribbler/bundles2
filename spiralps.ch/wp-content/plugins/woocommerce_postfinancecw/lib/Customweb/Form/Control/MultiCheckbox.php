 ...
 *
 */
class Customweb_Form_Control_MultiCheckbox extends Customweb_Form_Control_Abstract {
	 ...
	 */
	public function __construct($controlName, array $options, array $defaultValues = array()) {
