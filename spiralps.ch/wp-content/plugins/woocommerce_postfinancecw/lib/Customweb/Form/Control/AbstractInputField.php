 ...
 *
 */
abstract class Customweb_Form_Control_AbstractInputField extends Customweb_Form_Control_Abstract {
	...
	public function renderContent(Customweb_Form_IRenderer $renderer) {
		...
		return '<input type="' . $this->getInputType() . '" ' . $autocomplete . ' name="'. $this->getControlName() . '" id="'. $this->getControlId() . '" value="' . $this->getDefaultValue() . '" class="' . $this->getCssClass() . '" />';
	}
