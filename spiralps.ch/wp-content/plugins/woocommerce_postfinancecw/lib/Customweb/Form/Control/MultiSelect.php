 ...
 *
 */
class Customweb_Form_Control_MultiSelect extends Customweb_Form_Control_Abstract {
	 ...
	 */
	public function __construct($controlName, $options, array $defaultValues = array()) {
