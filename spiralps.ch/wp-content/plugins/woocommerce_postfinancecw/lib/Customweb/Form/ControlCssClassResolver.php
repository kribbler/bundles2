...
class Customweb_Form_ControlCssClassResolver implements Customweb_Form_IControlCssClassResolver
{
	...
	/**
	 * (non-PHPdoc)
	 * @see Customweb_Form_IControlCssClassResolver::resolveClass()
	 */
	public function resolveClass(Customweb_Form_Control_IControl $control, Customweb_Form_Element $element) {
		return "";
	}
