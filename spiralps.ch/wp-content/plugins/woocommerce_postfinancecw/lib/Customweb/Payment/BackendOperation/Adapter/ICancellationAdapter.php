...
require_once 'Customweb/Payment/IBaseAdapter.php';
 ...
 *
 */
interface Customweb_Payment_BackendOperation_Adapter_ICancellationAdapter extends Customweb_Payment_IBaseAdapter{
