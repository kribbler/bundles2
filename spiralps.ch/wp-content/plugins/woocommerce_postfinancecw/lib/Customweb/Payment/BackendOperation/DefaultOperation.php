...
class Customweb_Payment_BackendOperation_DefaultOperation implements Customweb_Payment_BackendOperation_IOperation {
	...
	/**
	 * (non-PHPdoc)
	 * @see Customweb_Payment_BackendOperation_IOperation::getName()
	 */
	...
	/**
	 * (non-PHPdoc)
	 * @see Customweb_Payment_BackendOperation_IOperation::getDescription()
	 */
	...
	/**
	 * (non-PHPdoc)
	 * @see Customweb_Payment_BackendOperation_IOperation::getIdentifier()
	 */
	...
	/**
	 * (non-PHPdoc)
	 * @see Customweb_Payment_BackendOperation_IOperation::canAcceptOrderModifications()
	 */
