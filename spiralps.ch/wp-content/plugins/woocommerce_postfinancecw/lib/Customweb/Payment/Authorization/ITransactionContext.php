...
interface Customweb_Payment_Authorization_ITransactionContext {
	...
	/**
	 * Deferred means that the payment is not charged directly. It is chared later
	 ...
	 *
	 * @return String The transaction identifier of the transaction.
	 */
	public function getTransactionId();
	
	/**
	 * This method returns if the payment should be captured or deferred (only a reservation on the card)
	 * processed. This value overrides setting of the payment method. In case the default value of 
	...
	/**
	 * This method returns string, which identifies the alias to use for the transaction. If this method 
	...
	/**
	 * Define list of key/value pairs returned by this method are added to the transaction. The result URLs 
