...
require_once 'Customweb/Payment/Authorization/IProcessAdapter.php';
 ...
 *
 */
interface Customweb_Payment_Authorization_PaymentPage_IAdapter extends Customweb_Payment_Authorization_IAdapter, Customweb_Payment_Authorization_IProcessAdapter {
