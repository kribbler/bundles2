...
class Customweb_PostFinance_Refund_RefundParameterBuilder extends Customweb_PostFinance_MaintenanceParameterBuilder {
	...
	protected function getOperationParameter() {
		if (Customweb_Payment_Util::amountEqual($this->getTransaction()->getCapturedAmount(), $this->refundAmount) || $this->close) {
			return array('OPERATION' => Customweb_PostFinance_IAdapter::OPERATION_REFUND_FULL);
		}
		else {
			return array('OPERATION' => Customweb_PostFinance_IAdapter::OPERATION_REFUND_PARTIAL);
		}
	}
