...
class Customweb_PostFinance_Authorization_Server_ParameterBuilder extends Customweb_PostFinance_MaintenanceParameterBuilder {
	...
	protected function getReactionUrlParameters() {
		return array(
			...
			'DECLINEURL' => $this->getTransactionContext()->getNotificationUrl(),
