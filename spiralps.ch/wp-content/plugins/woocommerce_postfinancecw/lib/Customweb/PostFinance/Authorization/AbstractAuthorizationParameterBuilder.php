...
abstract class Customweb_PostFinance_Authorization_AbstractAuthorizationParameterBuilder extends Customweb_PostFinance_MaintenanceParameterBuilder {
	
	protected $formData;
	
	public function __construct($transaction, $configuration, $formData) {
