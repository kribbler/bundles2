...
require_once 'Customweb/PostFinance/Authorization/AbstractAuthorizationParameterBuilder.php';
require_once 'Customweb/Util/Url.php';
require_once 'Customweb/Payment/Util.php';
require_once 'Customweb/Util/String.php';
require_once 'Customweb/PostFinance/Util.php';

class Customweb_PostFinance_Authorization_Recurring_ParameterBuilder extends Customweb_PostFinance_Authorization_AbstractAuthorizationParameterBuilder
{
	
	public function __construct($transaction, Customweb_PostFinance_Configuration $configuration) {
		parent::__construct($transaction, $configuration, array());
	}
	...
	public function buildParameters() {
		...
		$parameters['ECI'] = Customweb_PostFinance_IAdapter::ECI_REGULAR_RECURRING;
