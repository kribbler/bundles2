...
class Customweb_Http_Request {
	...
	protected function createSocketStream() {
		...
		$fp = stream_socket_client($socket, $errno, $errstr, 10, STREAM_CLIENT_CONNECT, $this->createStreamContext());
	 ...
	 * @throws Customweb_Http_ConnectionException
	 */
	private function handleSocketErrors($errno, $errstr, $errfile, $errline) {
