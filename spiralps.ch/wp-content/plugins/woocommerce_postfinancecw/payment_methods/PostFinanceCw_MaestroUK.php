...
class PostFinanceCw_MaestroUK extends PostFinanceCw_PaymentMethod
{
	public $machineName = 'maestrouk';
	public $admin_title = 'Maestro UK';
	public $title = 'Maestro UK';
	
	public function __construct() {
		$this->icon = apply_filters(
			'woocommerce_postfinancecw_maestrouk_icon', 
			PostFinanceCwUtil::getAssetsUrl('icons/maestrouk.png')
		);
		parent::__construct();
	}
