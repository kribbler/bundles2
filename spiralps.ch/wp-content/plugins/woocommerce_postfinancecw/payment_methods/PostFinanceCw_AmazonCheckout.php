...
class PostFinanceCw_AmazonCheckout extends PostFinanceCw_PaymentMethod
{
	public $machineName = 'amazoncheckout';
	public $admin_title = 'Amazon Checkout';
	public $title = 'Amazon Checkout';
	
	public function __construct() {
		$this->icon = apply_filters(
			'woocommerce_postfinancecw_amazoncheckout_icon', 
			PostFinanceCwUtil::getAssetsUrl('icons/amazoncheckout.png')
		);
		parent::__construct();
	}
