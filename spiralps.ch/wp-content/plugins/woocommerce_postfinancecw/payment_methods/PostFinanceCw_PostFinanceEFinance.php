...
class PostFinanceCw_PostFinanceEFinance extends PostFinanceCw_PaymentMethod
{
	...
	public function __construct() {
		$this->icon = apply_filters(
			'woocommerce_postfinancecw_postfinanceefinance_icon', 
			PostFinanceCwUtil::getAssetsUrl('icons/postfinanceefinance.png')
		);
		parent::__construct();
	}
