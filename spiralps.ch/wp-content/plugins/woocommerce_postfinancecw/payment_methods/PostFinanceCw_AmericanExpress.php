...
class PostFinanceCw_AmericanExpress extends PostFinanceCw_PaymentMethod
{
	...
	public function __construct() {
		$this->icon = apply_filters(
			'woocommerce_postfinancecw_americanexpress_icon', 
			PostFinanceCwUtil::getAssetsUrl('icons/americanexpress.png')
		);
		parent::__construct();
	}
