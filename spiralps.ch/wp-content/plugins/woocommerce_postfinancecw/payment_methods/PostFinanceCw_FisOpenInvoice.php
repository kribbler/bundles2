...
class PostFinanceCw_FisOpenInvoice extends PostFinanceCw_PaymentMethod
{
	public $machineName = 'fisopeninvoice';
	public $admin_title = 'PostFinance FIS Open Invoice';
	public $title = 'PostFinance FIS Open Invoice';
	
	public function __construct() {
		$this->icon = apply_filters(
			'woocommerce_postfinancecw_fisopeninvoice_icon', 
			PostFinanceCwUtil::getAssetsUrl('icons/fisopeninvoice.png')
		);
		parent::__construct();
	}
