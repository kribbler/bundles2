...
class PostFinanceCw_MasterCard extends PostFinanceCw_PaymentMethod
{
	...
	public function __construct() {
		$this->icon = apply_filters(
			'woocommerce_postfinancecw_mastercard_icon', 
			PostFinanceCwUtil::getAssetsUrl('icons/mastercard.png')
		);
		parent::__construct();
	}
