...
class PostFinanceCw_CarteBleue extends PostFinanceCw_PaymentMethod
{
	...
	public function __construct() {
		$this->icon = apply_filters(
			'woocommerce_postfinancecw_cartebleue_icon', 
			PostFinanceCwUtil::getAssetsUrl('icons/cartebleue.png')
		);
		parent::__construct();
	}
