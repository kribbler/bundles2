...
<?php get_header(); ?>
<?php
$real_home_pages_class = (is_front_page() && is_home() && !$_GET) ? "real-home-page" : "";
?>
<div id="page" class="home-page <?php echo $real_home_pages_class;?>">
	<div class="content">
		<div class="article">
				...
				<article class="<?php echo 'pexcerpt'.$i++?> post excerpt <?php echo (++$j % 2 == 0) ? 'last' : ''; ?>">
					...
					<?php if (empty($mts_options['mts_full_posts'])) : ?>
						<?php if ( has_post_thumbnail() ) { ?>
							<a href="<?php echo $external_url ?>" target="_blank" title="<?php the_title(); ?>" rel="nofollow" id="featured-thumbnail">
						...
						<?php } else { ?>
							<a href="<?php echo $external_url ?>" target="_blank" title="<?php the_title(); ?>" rel="nofollow" id="featured-thumbnail">
								<div class="featured-thumbnail">
									<img src="<?php echo get_site_thumb($post->ID);?>" class="attachment-featured wp-post-image" alt="<?php the_title(); ?>" />
					...
					<header>						
						<h2 class="title">
							<a href="<?php echo $external_url ?>" target="_blank" title="<?php the_title(); ?>" rel="bookmark"><?php the_title(); ?></a>
						</h2>
		...
		<?php if (!is_front_page() && !is_home() || $_GET) get_sidebar(); ?>
		<?php get_footer(); ?>