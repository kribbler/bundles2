		...
		<?php if(isset($mts_options['mts_trending_articles'])) { if($mts_options['mts_trending_articles'] == '1' && $mts_options['mts_trending_articles'] != '') { ?>
			...
			?>
				...
				<ul>
					...
					echo '<li class="trendingPost"><a href="' . esc_url( home_url( '/' ) ) . '">Hjem</a></li>';
					echo '<li class="trendingPost"><a href="' . esc_url( home_url( '/mat' ) ) . '">Mat</a></li>';
					echo '<li class="trendingPost"><a href="' . esc_url( home_url( '/motor' ) ) . '">Motor</a></li>';
					echo '<li class="trendingPost"><a href="' . esc_url( home_url( '/reise' ) ) . '">Reise</a></li>';
					echo '<li class="trendingPost"><a href="' . esc_url( home_url( '/sport' ) ) . '">Sport</a></li>';
					echo '<li class="trendingPost"><a href="' . esc_url( home_url( '/okonomi' ) ) . '">Økonomi</a></li>';
					echo '<li class="trendingPost last"><a href="' . esc_url( home_url( '/index/' ) ) . '">A-Å</a></li>';					
					/*
					$i = 1;
					foreach ($categories as $category){?>
						<li class="trendingPost <?php if($i % 5 == 0){echo 'last';} ?>">
							<a href="/<?php echo $category->slug ?>" title="<?php echo $category->name; ?>" rel="bookmark"><?php echo $category->name; ?></a>
						</li>    
					<?php $i++;}
					*/
					?>
