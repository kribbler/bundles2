...
class WC_Compare_Product_Page_Global_Settings extends WC_Compare_Admin_UI
{
	...
	public function after_save_settings() {
		if ( ( isset( $_POST['bt_save_settings'] ) || isset( $_POST['bt_reset_settings'] ) ) && get_option( 'woo_compare_product_clean_on_deletion' ) == 0  )  {
	...
	public function init_form_fields() {
     	...
     	$this->form_fields = apply_filters( $this->option_name . '_settings_fields', array(
			...
			array(  
				...
				'id' 		=> 'woo_compare_product_clean_on_deletion',
				'type' 		=> 'onoff_checkbox',
				'default'	=> 1,
