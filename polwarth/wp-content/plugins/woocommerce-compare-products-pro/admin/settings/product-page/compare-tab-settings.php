...
class WC_Compare_Product_Page_Compare_Tab_Settings extends WC_Compare_Admin_UI
{
	...
	public function init_form_fields() {
     	...
     	$this->form_fields = apply_filters( $this->option_name . '_settings_fields', array(
			...
			array(  
				'name' 		=> __( "Compare Attributes Tab", 'woo_cp' ),
			...
			array(  
				'name' 		=> __( 'Compare Attributes Tab', 'woo_cp' ),
				'desc_tip'	=> __( 'Select the position of the Compare Attributes tab on the default WooCommerce product page Nav bar. Products Compare feature list shows under the tab.', 'woo_cp' ),
