...
class WC_Compare_Comparison_Table_Content_Style_Settings extends WC_Compare_Admin_UI
{
	...
	public function init_form_fields() {
     	...
     	$this->form_fields = apply_filters( $this->option_name . '_settings_fields', array(
			...
			array(
            	'name' 		=> __( 'Compare Attribute Titles (Left Fixed Column)', 'woo_cp' ),
                'type' 		=> 'heading',
           	),
			array(  
			...
			array(
            	'name' 		=> __( 'Table Rows Attribute Values Font', 'woo_cp' ),
                'type' 		=> 'heading',
           	),
			array(  
			...
			array(
            	'name' 		=> __( 'Empty Attribute Values Row Cell Display', 'woo_cp' ),
                'type' 		=> 'heading',
           	),
			array(  
