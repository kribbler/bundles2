...
// Set Compare Meta Tables
add_action( 'init', array( 'WC_Compare_Functions', 'set_metadata_wpdbfix' ), 0 );
add_action( 'switch_blog', array( 'WC_Compare_Functions', 'set_metadata_wpdbfix' ), 0 );
...
add_action('wp_ajax_wccp_help_blue_message_dontshow', array('WC_Compare_Functions', 'wccp_help_blue_message_dontshow') );
add_action('wp_ajax_nopriv_wccp_help_blue_message_dontshow', array('WC_Compare_Functions', 'wccp_help_blue_message_dontshow') );

// AJAX hide yellow message dismiss
add_action('wp_ajax_wccp_help_blue_message_dismiss', array('WC_Compare_Functions', 'wccp_help_blue_message_dismiss') );
add_action('wp_ajax_nopriv_wccp_help_blue_message_dismiss', array('WC_Compare_Functions', 'wccp_help_blue_message_dismiss') );
...
add_action('wp_ajax_woocp_update_orders', array('WC_Compare_Features_Panel', 'woocp_update_orders') );
add_action('wp_ajax_nopriv_woocp_update_orders', array('WC_Compare_Features_Panel', 'woocp_update_orders') );
...
add_action( 'init', 'woo_cp_pro_upgrade_plugin' );
function woo_cp_pro_upgrade_plugin () {
	// Upgrade to 2.0.0
	...
	if( version_compare(get_option('a3rev_woocp_pro_version'), '2.0.7') === -1 ){
		include( WOOCP_DIR. '/includes/updates/compare-update-2.0.7.php' );
	...
	// Upgrade to 2.1.8
	if( version_compare(get_option('a3rev_woocp_pro_version'), '2.1.5') === -1 ) {
		include( WOOCP_DIR. '/includes/updates/compare-update-2.1.5.php' );
		update_option('a3rev_woocp_pro_version', '2.1.5');
	}
	
	// Upgrade to 2.1.8
	if( version_compare(get_option('a3rev_woocp_pro_version'), '2.2.0') === -1 ) {
		include( WOOCP_DIR. '/includes/updates/compare-update-2.2.0.php' );
