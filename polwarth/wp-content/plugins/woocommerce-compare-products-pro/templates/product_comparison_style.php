...
/* Compare Attribute Titles ( Left Fixed Column) Style */
.compare_value {
	/* Font */
...
/* Table Rows Attribute Values Font */
.td-spacer {
	/* Font */
...
/* Empty Attribute Values Row Cell Display */
...
.compare_popup_print #product_comparison th, .compare_popup_print #product_comparison td {
	border-right: <?php echo $table_border['size']; ?> <?php echo $table_border['style']; ?> <?php echo $table_border['color']; ?> !important;
	border-bottom: <?php echo $table_border['size']; ?> <?php echo $table_border['style']; ?> <?php echo $table_border['color']; ?> !important;
}
</style>