...
<body>
		<?php
		$print_custom_class = '';
		$print_button_text = $woo_compare_print_page_settings['print_link_text'];
		$print_button_class = 'compare_print_link_type';
		if ($woo_compare_print_page_settings['print_button_type'] == 'button') {
			...
			jQuery(document).ready(function($) {
						...
						$(document).on("click", ".woo_compare_popup_remove_product", function(){
							...
							$.post( ajax_url, data, function(response) {
								$("body").trigger("woo_popup_remove_product_from_compare_list", [popup_remove_product_id]);
								data = {
								...
								$("body").trigger("woo_update_compare_popup");
