<?php
/*
Template Name: 6 Columns Portfolio
*/
?>
			...
			">
				...
				<div class="row-fluid">
					<div class="span12">	
						...
						<img alt="<?php echo $alt; ?>" src="<?php $image = wp_get_attachment_image_src( get_post_thumbnail_id( $post->ID ), 'default-page' ); echo $image[0];?>" /><div class="divider20"></div>
					</div>
				</div>
				<?php }?>
				<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
				...
				<div class="row">
                	<div id="container" class="portfolio clearfix">
						...
						<div class="element post portfolio span2 <?php if($terms) : foreach ($terms as $term) { echo ''.$term->slug.' '; } endif; ?>">
