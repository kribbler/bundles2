...
?>
		...
		<?php if (!is_page_template('template-simple-page.php')){?>
				...
				<div class="row-fluid">
					<div class="span6">
						<div class="wrap-tagline">
							...
							<?php if ( in_array( 'woocommerce/woocommerce.php' , get_option('active_plugins') ) ) {?>
								<?php /*
								 * extra condition added by daniel: "&& !is_productcategory()"
								 * for that right tagline and description to be invisible. 
								 */
								 ?>
