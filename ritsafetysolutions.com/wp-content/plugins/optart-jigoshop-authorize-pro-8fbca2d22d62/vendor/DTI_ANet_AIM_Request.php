 ...
 *  define( "DTI_AUTHORIZENET_SANDBOX", false );
 *  -- OR -- 
 *  $sale = new DTI_ANet_AIM_Request();
 ...
 *
 */
class DTI_ANet_AIM_Request extends DTI_ANet_Request
{
	 ...
	 *
	 *  @return DTIAuthorizeNetResponse_AIM
	 */
	...
	public function setField( $name, $value )
	{
		if ( $this->verify_x_fields ) {
			if ( in_array( $name, $this->_all_aim_fields ) ) {
				...
				throw new DTIAuthorizePROException("Error: no field $name exists in the AIM API.
	...
	{
		return new DTI_ANet_AIM_Response( $response, $this->_x_post_fields['delim_char'], $this->_x_post_fields['encap_char'], $this->_custom_fields );
	}
