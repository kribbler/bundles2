...
?>
	...
	<?php query_posts( array( 'post_type' => 'slideshows', 'showposts' => 10000,'orderby'=>'date','order'=>'ASC' ) );
	...
	if ($active) {
	?>	
		<a href="<?php echo $thislink; ?>" style="height: 316px">
