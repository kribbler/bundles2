...
<link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/slider/jquery.bxslider.css" type="text/css" />
...
<link rel="stylesheet" type="text/css" media="all" href="<?php echo get_template_directory_uri(); ?>/fancybox/jquery.fancybox-1.3.4.js" />
<link rel="pingback" href="<?php bloginfo( 'pingback_url' ); ?>" />
<script type="text/javascript" src="http://w.sharethis.com/button/buttons.js"></script>
<script type="text/javascript">
stLight.options({publisher: "ur-c9d36704-7653-919a-6794-745e28353a51"});
</script>
<?php
if ( is_singular() && get_option( 'thread_comments' ) ) wp_enqueue_script( 'comment-reply' );
wp_enqueue_script( 'jquery' );
wp_enqueue_script( get_template_directory_uri().'/slider/jquery.bxslider.min.js' );
wp_head();
?>
<script src="<?php echo get_template_directory_uri(); ?>/slider/jquery.bxslider.min.js" type="text/javascript"></script>
<script src="<?php echo get_template_directory_uri(); ?>/js/audio-player.js" type="text/javascript"></script>
	<script type="text/javascript">  
     ...
     <script type="text/javascript"> 
         jQuery(document).ready(function() {
             jQuery(".tablepress tbody tr:even").addClass("even");
             jQuery(".tablepress tbody tr:odd").addClass("odd");
             jQuery(".tablepress tbody tr td:odd").addClass("td-odd");
             jQuery(".tablepress tbody tr td:even").addClass("td-even");
         });
         
         </script>
        <script type="text/javascript"> 
           jQuery(document).ready(function() {
              jQuery("ul#events-calendar-list li:first").addClass("first_event"); 
           });
       </script>
<?php 
